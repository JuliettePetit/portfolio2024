...
export default function ProjectsLogo(props:{className:string}) {
  return (
    <svg className={"w-6 h-6 m-10 "+ props.className} xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 256 256">
<g transform="scale(2.81 2.81)" >
	<path d="M 81.63 60.863 H 8.37 c -1.433 0 -2.595 -1.162 -2.595 -2.595 V 12.745 c 0 -1.615 1.309 -2.924 2.924 -2.924 h 72.601 c 1.615 0 2.924 1.309 2.924 2.924 v 45.523 C 84.225 59.701 83.063 60.863 81.63 60.863 z M 10.654 55.983 h 68.691 V 14.7 H 10.654 V 55.983 z"/>
